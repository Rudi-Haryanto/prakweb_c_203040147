...
function koneksi() {
 ...
 return mysqli_connect("localhost", "root", "","Prakweb_C_203040147");
...
function add($Buku) {
    ...
    $Pengarang = htmlspecialchars($Buku['Penerbit']);
    $Penerbit = htmlspecialchars($Buku['tipe']);
...
function ubah($Buku) {
    ...
    $Pengarang = htmlspecialchars($Buku['tipe']);
